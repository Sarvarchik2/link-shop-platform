    ...
    <div class="container py-8">
      <div class="register-card">
        ...
        <div v-if="!user" class="auth-notice">
          <p>Для создания магазина необходимо войти в систему</p>
          <div class="auth-actions">
            <NuxtLink to="/login" class="btn-primary">Войти</NuxtLink>
            <NuxtLink to="/register" class="btn-secondary">Зарегистрироваться</NuxtLink>
          </div>
        </div>
        ...
        <div class="info-box">
          ...
          <ul>
            ...
            <li>Админка магазина будет доступна в вашем профиле</li>
          </ul>
        </div>
      </div>
    </div>
