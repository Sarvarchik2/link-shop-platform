  ...
  <div class="platform-admin-page">
    ...
    <aside class="admin-sidebar">
      ...
      <nav class="sidebar-nav">
        ...
        <NuxtLink to="/platform/admin/shops" class="nav-item">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <NuxtLink to="/platform/admin/orders" class="nav-item active">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
...
const { data: orders, pending } = await useFetch('http://localhost:8000/platform/admin/orders', {
  server: false,
  headers: {
