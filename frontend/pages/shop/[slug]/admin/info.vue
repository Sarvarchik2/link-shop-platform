      ...
      <div class="admin-content">
        <form @submit.prevent="handleSubmit" class="shop-info-form">
          ...
          <div class="form-footer">
            <NuxtLink :to="localePath(`/shop/${shopSlug}/admin`)" class="btn-cancel">{{ $t('common.cancel') }}
            </NuxtLink>
...
const { data: shop, refresh } = useFetch(`${config.public.apiBase}/platform/shops/${shopSlug.value}`, {
...
const handleSubmit = async () => {
  loading.value = true
  try {
    await $fetch(`${config.public.apiBase}/shop/${shopSlug.value}/admin/info`, {
      method: 'PUT',
      headers: {
