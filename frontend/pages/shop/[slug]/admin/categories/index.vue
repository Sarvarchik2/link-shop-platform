  ...
  <div class="shop-admin-page">
    ...
    <main class="admin-main">
      <div class="page-header">
        ...
        <NuxtLink :to="localePath(`/shop/${shopSlug}/admin/categories/new`)" class="btn btn-primary">
...
const { data: categories, error, refresh } = useFetch(`${config.public.apiBase}/categories?shop_slug=${shopSlug}`, {
  server: false,
  lazy: true,
  headers: computed(() => ({
